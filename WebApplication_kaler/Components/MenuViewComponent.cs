...
namespace WebApplication_kaler.Components
{
    public class MenuViewComponent : ViewComponent
    {
        ...
        {
        new MenuItem{ Controller="Home", Action="Index", Text="Kaler E.A."},
        ...
        new MenuItem{ IsPage=true, Area="ApiDemo", Page="/Index", Text="API-демо"}
        };
